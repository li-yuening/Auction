...
import edu.uibe.database.DBUtil;
...
//				//String[] parameters3 = {"4","闄�,"","","","","宸滱12000"};
...
//
	...
	public ArrayList<ItemInfo> executeQueryItem(){
		ArrayList<ItemInfo> list = new ArrayList<ItemInfo>();
		String sql = "select * from auction.dbo.物品信息";
...
//				+ "where VacuumOver=0 and AirProofTestOver=1 and FinalDetectResult<>'鍚堟牸'";
//		String[] parameters =null;
//		ResultSet rs = DBUtil.executeQuery(sql, parameters);
//		try {
//			while(rs.next()){
...
//				String[] parameters={"鍒ゅ簾",nowTime,detectDetailResult,gdr.getAppearDetail(),gdr.getSoundDetail(),gdr.getWhorlDetail(),
...
//		if(result.equals("0")){
//			String[] parameters={"鍒ゅ簾",nowTime,nddr.getNoneDestructivePosition(),nddr.getNoneDestructiveDetail(),"0","1",nddr.getOperatorName(),nowTime,"WS",nddr.getBottleDetectNumber()};
//			DBUtil.executeUpdate(sql, parameters);
//		}else{
...
//		if(api.getAirProofTestResult().equals("鍒ゅ簾")){
//			String[] parameters={"鍒ゅ簾",nowTime,api.getAirProofTestMethod(),api.getAirProofTestMedium(),api.getAirProofTestTemp(),
...
//			}else{
//				sql1="update BottleDetectInfo set FinalDetectResult='"+"鍚堟牸"+"', FinalDetectDate='"+nowTime+"', "
